...
export default function Pricing() {
  ...
  return (
    <div
      id="services"
      className={`${inter.className} xl:h-screen min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-700 px-5 py-12 overflow-hidden`}
