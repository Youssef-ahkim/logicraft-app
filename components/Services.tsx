...
export default function Pricing() {
  ...
  return (
    <div
      id="services"
      className={`${inter.className} px-5 pt-4 pb-12 min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-blue-500 via-indigo-600 to-purple-700  overflow-hidden`}
